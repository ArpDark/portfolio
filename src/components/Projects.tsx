        ...
        <div id="projects" className="flex flex-col pt-16 items-center">
            ...
            <div className="grid grid-cols-4 gap-x-4 mx-4 mt-6 ">
                ...
                {/* <div className=" flex flex-col bg-white rounded-md p-2 items-center shadow-md shadow-gray-700">
                    ...
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/ArpDark/portfolio" className="">GitHub Link</a>
                    <a target="_blank" rel="noopener noreferrer" href="https://aritrapal.vercel.app/" className="">Live Link</a>
                </div> */}

                <div className=" flex flex-col bg-gray-600 rounded-md p-2 items-center shadow-md shadow-gray-700 font-mono text-white">
